      ...
      if (keyCode == 13) {
        switch (field) {
          ...
          case "submit":
            ...
            reminder.when = moment(reminder.when)
              .utc()
              .valueOf();
            // reminder.frequency = moment(reminder.frequency * 60).utc().valueOf();
            this
              .props
              .addReminder(reminder); // handleChange App state
            this.setState({
              reminder: {
                alert: "",
                when: moment
    ...
    switch (this.state.currentInput) {
      case "alert":
        return <input
          ...
          onKeyPress={this.handleSubmit("alert")}
          autoFocus/>;
      case "when":
        return <div className="label-container">
          ...
          <input
            ...
            onKeyPress={this.handleSubmit("when")}
            autoFocus/>
        </div>;
      case "frequency":
        return <div className="label-container">
          ...
          <div>
            <span>
              ...
              <input
                ...
                onKeyPress={this.handleSubmit("frequency")}
                autoFocus/>
              hours.
            </span>
          </div>
        ...
        return <div className="label-container">
          ...
          <div>
            <input
              ...
              type="time"
              value={betweenStart}
              onChange={this.handleChange("betweenStart")}
              onKeyPress={this.handleSubmit("between")}
              autoFocus/>
            &amp;
            <input
              id="betweenEnd"
              type="time"
              value={betweenEnd}
              onChange={this.handleChange("betweenEnd")}
              onKeyPress={this.handleSubmit("between")}/>
          </div>
        </div>;
      case "submit":
